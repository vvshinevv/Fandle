	...
	<article id="board_area">
		<header>
			...
			<!-- <?php
				...
				//echo form_open('administration/project/progress_project_write/progress_project/projects_id/'.$this->uri->segment(6), $attributes);
			?> -->
				<fieldset>
					<legend>진행 프로젝트 추가</legend>
					...
					<table cellspacing="0" cellpadding="0" class="table table-striped">
						...
						<tr>
							<th>진행 프로젝트 제목</th>
							<td>
								<input type="text" id="progress_subject" name="progress_subject" value="<?php echo set_value('progress_subject')?>">
						...
						<tr>
							...
							<td>
								<input type="text" id="progress_youtube_url" name="progress_youtube_url" value="<?php echo set_value('progress_youtube_url')?>" placeholder="영상이 없으면 비어두세요.">
								<div>진행 프로젝트 영상 URL을 입력하세요</div>
							</td>
						</tr>
						<tr>
							<th>진행 프로젝트 내용</th>	
						...
						<tr>
							<td colspan="2">
								<textarea class="col-md-12" id="progress_contents" name="progress_contents" style="padding: 0px;"><?php echo set_value('progress_contents')?></textarea>
							</td>
						</tr>
						</tbody>
						<tfoot></tfoot>
