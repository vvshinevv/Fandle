	...
	<div class="main-container">
		<div class="container">
			<h2 class="title" style="color: black; text-align: center;">Social Register</h2>
			<div class="row form-block center-block" style="border: 1px solid #dcdcdc;">
				<div class="main object-non-visible" data-animation-effect="fadeInUpSmall" data-effect-delay="100">
					<form class="form-horizontal col-sm-12" method="post" action="" id="sign_action" style="padding-top: 10px;">
						<div class="col-sm-6">
							<?php
							if($social_register['email'] === 'undefined') {
								$email = null;
							} else {
								$email = $social_register['email'];
							}
							?>
							<div class="form-group has-feedback">
								<div class="col-sm-12">
									<input type="email" class="form-control col-md-6" id="email" name="email" placeholder="<?php echo $this->lang->line('email'); ?>" value="<?php echo $email; ?>" required>
							...
							<div class="form-group has-feedback">
								<div class="col-sm-12">
									<input type="text" class="form-control" id="username" name="username" placeholder="<?php echo $this->lang->line('userName'); ?>" value="<?php echo $social_register['username']; ?>" required>
